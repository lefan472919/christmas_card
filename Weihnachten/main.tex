...
\node [color = blue!70!white , fill = blue!30!white] at (-3,9) {\fontsize{50}{80}$M_k = \sum_{i=1}^k u_i \sigma_i v_i^\top$};
\node [color = blue!70!white , fill = blue!30!white] at (3,4.5) {\Large{$\ket{\psi} = \sum_{\sigma_1,\dots,\sigma_n} c_{\sigma_1\dots\sigma_n} \ket{\sigma_1\dots\sigma_n}, \sigma_i \in \{0,1\}$}} ;
\node [color = blue!70!white , fill = blue!30!white] at (-4.5,1) {\Large{$\ket{\psi} = \sum_{a_l} s_{a_l} \ket{a_l}_A \ket{a_l}_B $}};
\node [color = blue!70!white , fill = blue!30!white] at (-4.4,-1.) {\huge{$f(x) = \frac{1}{\sqrt{2\pi}}e^{-\frac{1}{2}(x-2^{L-1})^2}$}};
\node [color = blue!70!white , fill = blue!30!white] at (-3,3) {$C^iR^j_k = \frac{1}{2}( 1 + Z) \otimes 1 +\frac{1}{2}(1 - Z) \otimes  R_k.$};
\node [color = blue!70!white , fill = blue!30!white] at (-5.5,-4.5) {\large{$f = n^2\cdot p.$}};
\node [color = blue!70!white , fill = blue!30!white] at (4.7,-2.5) {\Large{$\ket{\sigma} \rightarrow \frac{1}{\sqrt{N}}\sum_{k=1}^N e^{2\pi i \sigma k /N} \ket{k}$}};
\node [color = blue!80!white , fill = blue!30!white] at (5,1.5) {\Huge{$ U = 2 \pi r ^2 $ ? }};
\node [color = blue!70!white , fill = blue!30!white] at (5.8,-5) {$\Gamma^{\sigma_i'} = \sum_{\sigma_i} O_{\sigma_i', \sigma_i}\Gamma^{\sigma_i}$};
\node [color = blue!70!white , fill = blue!30!white] at (-4.9,-7.4) {$ k = \sum_{j=1}^{n} 2^{n-j} k_j \mbox{ , } k_j\in\{0,1\}$ };
\node [color = blue!70!white , fill = blue!30!white] at (6.3,-7.8) {$M= USV$ };
% random snowflakes
